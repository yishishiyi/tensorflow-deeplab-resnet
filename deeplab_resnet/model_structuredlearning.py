...
class DeepLabResNetStructuredLearningModel(Network):
    def setup(self, is_training, num_classes, embedding_size=2048, ASPP=True, CRN=False):
        '''Network definition.
        ...
        if ASPP:
            ...
            .atrous_conv(3, 3, embedding_size, 6, padding='SAME', relu=False, name='fc1_voc12_c0'))

            (self.feed('res5c_relu')
             .atrous_conv(3, 3, embedding_size, 12, padding='SAME', relu=False, name='fc1_voc12_c1'))

            (self.feed('res5c_relu')
            .atrous_conv(3, 3, embedding_size, 18, padding='SAME', relu=False, name='fc1_voc12_c2'))

            (self.feed('res5c_relu')
            .atrous_conv(3, 3, embedding_size, 24, padding='SAME', relu=False, name='fc1_voc12_c3'))
            ...
            (self.feed('res5b_relu',
             ...
             .add(name='res5c')
             .relu(name='res5c_relu')
             .atrous_conv(3, 3, embedding_size, 12, padding='SAME', relu=False, name='fc1_voc12'))

        if CRN:
            (self.feed('fc1_voc12')
             .crn(num_classes, embedding_size, name='crn'))
