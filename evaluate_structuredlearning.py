...
def main():
    ...
    # Create network.
    net = DeepLabResNetStructuredLearningModel({'data': image_batch}, is_training=False,
    ...
    # comment the following two linse due to it does not work on 1.3 version. (1.2 is fine)
    # see https://github.com/DrSleep/tensorflow-deeplab-resnet/issues/107
